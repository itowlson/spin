...
impl BadgerRecordManager {
    pub fn default() -> anyhow::Result<Self> {
        let base_dir = dirs::cache_dir()
            ...
            .ok_or_else(|| anyhow::anyhow!("Unable to get local data directory or home directory"))?;
    ...
    pub async fn previous_badger(&self, name: &str, current_version: &semver::Version) -> PreviousBadger {
